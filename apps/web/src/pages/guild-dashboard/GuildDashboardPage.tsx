...
export default function GuildDashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<TabType>('battle-report');
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'regear': return <RegearTab guildId={currentGuild.id} initialPreviewBattleIds={pendingRegearBattleIds} onPreviewClear={() => setPendingRegearBattleIds(null)} />;
